...
export default function SavedLine(props) {
    ...
    <div className="bg-white u-round-sm u-shadow-lg px-3 pt-2 pb-1">
      ...
      <div className="p-1 px-10-md u-text-center mt-3">
        <div className="mx-24-md p-4 u-round-sm u-shadow-md" style={{ border: "solid 1px lightgrey" }}>
          ...
          <input disabled style={{ cursor: "default", resize: "none" }} className="u-center input--sm" placeholder="The user will be able to provide a single line as an answer"></input>
        </div>
      </div>
