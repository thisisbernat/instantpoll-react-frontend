        ...
        <div className="bg-white u-round-sm u-shadow-lg px-2 py-3 grid-c-4-md">
            ...
            <div className="text-lg u-center mb-1">
                <ul className="no-bullets">
                    <li><label className="pointer"><input type="radio" name="house" /> JavaScript</label></li>
                    <li><label className="pointer"><input type="radio" name="house" /> TypeScript</label></li>
                    <li><label className="pointer"><input type="radio" name="house" /> Both</label></li>
                </ul>
            </div>
